...
for _, row in edges.iterrows():
    ...
    if G.has_edge(u, v):
        ...
        # 距离你看需要怎么处理：保持第一次、取平均、取最小都行
        # 例如取平均距离：
        # k = G[u][v]['weight']
        # G[u][v]['distance'] = (G[u][v]['distance'] * (k - 1) + dist) / k
    else:
...
nx.write_gml(G, "./GCN/global_airline_network.gml")
print("Graph saved to ./GCN/global_airline_network.gml")
